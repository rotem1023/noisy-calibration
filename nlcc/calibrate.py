...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset', type=str, required=True, help='Dataset name', default='path_mnist')
    ...
    Ts, losses = run_calibration_methods(input_data, n_bins, adaECE_calib, adaECE_eval)
    ...
    print(f"Data set: {data_set}, Source domain: {src_domain}, Target domain: {tgt_domain}")
    ...
    with open(f'{output_dir}/{data_set}_{src_domain}_{tgt_domain}_calibration_results.json', 'w') as f:
        json.dump(results, f)
